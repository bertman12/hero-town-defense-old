...
u = BlzCreateUnitWithSkin(p, FourCC("U001"), 0.1, 6.8, 284.430, FourCC("U001"))
...
DefineStartLocation(6, 13952.0, -5888.0)
DefineStartLocation(7, -12672.0, -5248.0)
DefineStartLocation(8, -3392.0, -3520.0)
DefineStartLocation(9, -9728.0, -4032.0)
